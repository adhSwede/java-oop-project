...
public class StoredCartRepository {
    ...
    public StoredCart getCartById(int cartId) throws SQLException {
        ...
        var result = SqlUtils.executeAndMap(query,
                Mappers.storedCartMapper,
    ...
    public void setActiveCart(int customerId,
                              int cartId) throws SQLException {
        ...
        SqlUtils.executeUpdate(deactivateQuery,
                customerId);
        SqlUtils.executeUpdate(activateQuery,
                cartId);
    }
    ...
    public void addItemToCart(int cartId,
        ...
        String query = "INSERT INTO cart_products (cart_id, product_id, quantity, unit_price) VALUES (?, ?, ?, ?)";
        SqlUtils.executeUpdate(query,
                cartId,
                productId,
                quantity,
    ...
    public void loadItems(StoredCart cart) throws SQLException {
        ...
        var rows = SqlUtils.executeAndMap(query,
                rs -> {
        ...
        for (var entry : rows) {
            Product product = RepositoryFactory
